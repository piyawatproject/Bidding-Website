...
import { getAllBkUserInfo, getBkUserInfo } from '../../../API/BidKarbUser';
...
function Signup(props) {
    ...
    return (
      ...
      <img className= "image1" src="../../../../src/img/123.png" alt="" />
        <h1 className="signup-title">Signup with BidKarb</h1>
        <SignupForm {...props} />
